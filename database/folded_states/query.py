...
from database.folded_states.build import DIMENSION, sync_faiss_with_db, session, index, faiss_to_db_id, State
from database.folded_states.learning import AncestryEnsemble # Import your architecture
...
def extract_sample():
    """
    Extract a sample of states to json, for visualization in manim video. This is a one-off function to get some data out of the database for a specific purpose.
